...
<fieldset class="wc-appointments-date-picker wc-appointments-date-picker-<?php esc_attr_e( $product_type ); ?> <?php esc_attr_e( implode( ' ', $class ) ); ?>">
	...
	<div class="wc-appointments-date-picker-date-fields">
        ...
        ?>
		<label>
			<input type="text" autocomplete="off" name="<?php esc_html_e( $name ); ?>_month" placeholder="<?php esc_html_e( 'mm', 'woocommerce-appointments' ); ?>" size="2" class="appointment_date_month" />
			<span><?php esc_html_e( 'Month', 'woocommerce-appointments' ); ?></span>
		</label> / <label>
			<input type="text" autocomplete="off" name="<?php esc_html_e( $name ); ?>_day" placeholder="<?php esc_html_e( 'dd', 'woocommerce-appointments' ); ?>" size="2" class="appointment_date_day" />
		...
		<?php endif; ?> / <label>
			<input type="text" autocomplete="off" name="<?php esc_html_e( $name ); ?>_year" value="<?php esc_html_e( date( 'Y' ) ); ?>" placeholder="<?php esc_html_e( 'YYYY', 'woocommerce-appointments' ); ?>" size="4" class="appointment_date_year" />
