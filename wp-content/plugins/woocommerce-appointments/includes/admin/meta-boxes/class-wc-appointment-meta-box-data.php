			...
			<div id="appointment_data" class="panel">
				...
				<div class="appointment_data_container appointment_data_general">
					<div class="appointment_data_column data_column_wide">
						...
						printf( esc_attr__( 'Appointment #%d', 'woocommerce-appointments' ), esc_attr( $post->ID ) );
						?>
						<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=wc_appointment&page=appointment_calendar&view=day&calendar_day=' . $appointment->get_start_date( 'Y-m-d', '' ) ) ); ?>" class="view-on-calendar" title="<?php echo esc_attr__( 'View on calendar', 'woocommerce-appointments' ); ?>"><span class="dashicons dashicons-calendar"></span></a>
						</h2>
